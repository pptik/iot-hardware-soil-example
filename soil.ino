...
void loop() {
  ...
  String lokasi = "";
  String jenis = "SensorSoil";
  data = dtostrf(analogRead(waterSensorsPin), 5, 2, message_buffer);
  String publisheddata = "#" + lokasi + "#" + jenis + "#" + data + "#";
